...
- The future of the critical temperate forest carbon (C) sink is contigent on the role of nuisance species, including non-indigenous pests and pathogens and deer, yet their net effect on current and future C cycling is little understood. Here, we use 15 years of census data from a 25.6-ha plot in a Mid-Atlantic temperate forest to understand how nuisance species are affecting C sequestration. 
