...
Yet, global C models predict a wide range of future trajectories of CO~2~ sequestration [@ahlström_robustness_2012;@arora_carbon_2020]<!--check refs-->, and current global C models do not represent some influential mechanisms [e.g., @fatichi_moving_2014].
