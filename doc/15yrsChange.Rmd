...
For the first time at the Front Royal ForestGEO site, C stocks have decreased since the last census (Figure 2). From 2018 to 2023, whole-plot C stocks have decreased from **"X to X"** Mg C/ha. Both low nuisance regions show similar decreases in C stocks going from **"X to X"** and **"X to X"** Mg C/ha respectively. The magnitude of the C stock decrease in the high deer high nuisance area from 2018 to 2023 is larger, going from **"X to X"** Mg C/ha. C stock decrease **is related to/ is explained by** above ground net woody production. In the first two census intervals, 2008 to 2013 and 2013 to 2018, there were positive C fluxes **VALUES?** and for the 2018 to 2023 interval there was a negative C flux of **VALUE Mg C/ha/year** (Figure 3a).
