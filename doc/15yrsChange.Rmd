...
Similarly, stand aging and climate change may both have contributed to the observed decline in AWP, which in turn contributed to reduced AGB.
Specifically, reductions in individual tree growth rates at this site are associated with increasing stem diameters, an aging stand, and rising summer temperatures **(Anderson-Teixeira et al. 2022, Dow et al. 2022)**.<!--refs need to be inserted.-->
...
The observed trends in AGB loss, including increasing AWM and decreasing AWP, will not necessarily be maintained as simple directional trends in the future.
The top dirver of increasing AWM has been EAB-driven mortality of *Fraxinus spp.*, but *Fraxinus* AWM has started declining as most individuals ≥10 cm have already died (Fig. `r mortality_by_genera`).
...
