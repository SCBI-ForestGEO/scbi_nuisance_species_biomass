...
loss_gain_net = 3 # 4-panel figure showing ∆AGB, loss, and gain for (a) whole plot, (b) upland, (c) deer exclosure, (d) graveyard

mortality_by_genera = 4 # 4-panel figure showing biomass mortality by genera for for (a) whole plot, (b) upland, (c) deer exclosure, (d) graveyard
...
![**Figure `r map_and_photos`. Photos within the SCBI ForestGEO plot: (a) represenative upland forest, (b) deer exclosure, (c) "tree graveyard" in NE corner ** *(Perhaps combine these with a map of the plot?)*](display/photos.png)
