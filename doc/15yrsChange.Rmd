...
While it is also possible that AWM will return to its previously low level as EAB recedes, we consider it very likely that oak decline, additional non-indigenous insects or pathogen species (e.g., beech leaf disease), and climate stressors will continue to elevate tree mortality at this site in the coming decades.
