...
# Papers to read
- earth system models (pay special attention to predictions and uncertainty for eastern US)
  - @wu_uncertainty_2023. - do they say anything about nuisance species?
  - @ahlstrom_robustness_2012
- @miller_overabundant_2023
  - what were there metrics? would it be worth applying their metrics to our forest in order to classify by their system?
...
Yet, global C models predict a wide range of future trajectories of CO~2~ sequestration [@ahlstrom_robustness_2012;@arora_carbon_2020]<!--check refs-->, and current global C models do not represent some influential mechanisms [e.g., @fatichi_moving_2014].
...
This is problematic in that nuisance species -- including non-endemic insect pests and pathogens, non-endemic plants, and over-abundant herbivores -- are dramatically impacting carbon cycling in temperate deciduous forests around the world [@refs]. 
